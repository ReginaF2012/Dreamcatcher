class ApplicationController < ActionController::Base
    ...
    helper_method :current_user, :logged_in?, :set_user, :require_login, :set_dreams
    ...
    # This is used in the DreamsController && the UsersController, hence why I assigned it as a helper method in the
    # ApplicationController and not a private method in the DreamController
    def set_dreams
